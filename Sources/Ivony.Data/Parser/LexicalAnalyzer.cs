...
namespace Ivony.Parser
{
  ...
  public abstract class LexicalAnalyzer : ILexicalAnalyzer
  {
    ...
    public IEnumerable<ITextToken> Tokenize( string text, int index = 0 )
    {
    ...
    private class Tokenizer
    {
      ...
      /// 获取当前使用的字符扫描器
      /// </summary>
      protected TextScaner Scaner { get; private set; }
      ...
      /// 获取要使用的词法分析器列表
      /// </summary>
      protected Func<TextScaner, ITextToken>[] Lexicals
      {
        get;
        private set;
      }
